  ...
  DrawerNotification.prototype.render = function render() {
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          TabPane,
          { className: 'tab-notification', tab: _i18next2.default.t('header:notification') + ' (' + numberOfNotificationText + ')',
            key: '1' },
        ...
        _react2.default.createElement(
          TabPane,
          { className: 'tab-announcement', tab: _i18next2.default.t('header:announcement') + ' (' + numberOfAnnouncementText + ')',
